...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("verificar voto");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtAno, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int anoatual = Integer.parseInt(txtAno.getText());
        int idade = anoatual - anonasc;
        
        if(idade<16){
            lblRes.setText("idade "+ idade + " Não vota");
        }else if((idade>=16 && idade<18)||(idade>70)){
            lblRes.setText("idade "+ idade +" Voto opcional");
        }else{
            lblRes.setText("idade "+ idade +" Voto obrigatorio");
        }
